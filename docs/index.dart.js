...
v=y.createTextNode("angulardart_bootstrap")
...
u=x.b
if(u==null)u=v
x.d="https://www.dartdocs.org/documentation/angulardart_bootstrap/latest/"+u+"/"+u+"-library.html"
t=H
z=2
return P.cK(W.m9("https://raw.githubusercontent.com/dart-land/angulardart_bootstrap/develop/demo/web/components/"+H.r(x.c)+"/"+H.r(x.c)+"_demo.dart",null,null),$async$u)
case 2:x.e=t.m(b)
t=H
z=3
return P.cK(W.m9("https://raw.githubusercontent.com/dart-land/angulardart_bootstrap/develop/demo/web/components/"+H.r(x.c)+"/"+H.r(x.c)+"_demo.html",null,null),$async$u)
case 3:x.f=t.m(b)
return P.ct(null,y)}})
...
J.t(S.c(w,"h1",t),w.createTextNode("angulardart_bootstrap"))
J.t(S.c(w,"p",t),w.createTextNode("Native Angular2 directives for Bootstrap 4"))
s=S.c(w,"a",t)
s.className="btn btn-primary"
v=J.u(s)
v.k(s,"href","https://github.com/dart-land/angulardart_bootstrap")
...
i7=S.c(w,"a",i6)
v=J.u(i7)
v.k(i7,"href","https://github.com/dart-land/angulardart_bootstrap")
v.h(i7,w.createTextNode("angulardart_bootstrap"))
v=J.u(i6)
