...
class DemoSection implements OnInit {
  ...
  ngOnInit() async {
    ...
    var rawMasterUrl = 'https://raw.githubusercontent.com/dart-land/angulardart_bootstrap/develop/demo';
    var componentsUrl = '$rawMasterUrl/web/components';
    var _docPath = docPath ?? docPathNameTN;
    docUrl = 'https://www.dartdocs.org/documentation/angulardart_bootstrap/latest/$_docPath/$_docPath-library.html';
